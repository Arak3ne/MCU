        ...
        <div v-for="(team, index) in leftTeams" :key="team.id" 
          ...
          <div class="flex justify-between items-center mb-3 pb-3 border-b border-mcu-border/60">
            <div class="flex items-center gap-3">
              <div class="w-4 h-4 rounded-full border border-mcu-bg shadow-[0_0_15px_currentColor]" :style="{ backgroundColor: team.color, color: team.color }"></div>
              <h2 class="text-2xl font-title uppercase tracking-[0.1em] text-mcu-text drop-shadow-md truncate max-w-[190px]" :style="{ textShadow: `0 0 8px ${team.color}66` }">{{ team.name }}</h2>
            </div>
