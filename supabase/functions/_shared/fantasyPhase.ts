...
/** Terminé : flag explicite, ou scores renseignés avec un vainqueur. */
...
/** Slots championship réellement jouables (pas de TBD / BYE). */
...
export function fantasyTournamentDayFromPlayoffs(
  matches: PlayoffMatchPhaseRow[] | null | undefined,
): 1 | 2 {
